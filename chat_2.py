...
class Chat:
	def __init__(self):
		...
		self.users['budi']={ 'nama': 'Budi Budi', 'negara': 'Indonesia', 'password': 'surabaya', 'incoming' : {}, 'outgoing': {}}
		self.users['andi']={ 'nama': 'Andi Andi', 'negara': 'Indonesia', 'password': 'surabaya', 'incoming': {}, 'outgoing': {}}
		self.users['tono']={ 'nama': 'Tono Tono', 'negara': 'Indonesia', 'password': 'surabaya','incoming': {}, 'outgoing':{}}
